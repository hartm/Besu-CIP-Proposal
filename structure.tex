...
Once the merge has occurred (and ``real'' transactions happen on the beacon chain), the node operator will send transaction fees to a splitter contract. designate the $feeRecipient$ in the $ExecutionaPayload$. 
